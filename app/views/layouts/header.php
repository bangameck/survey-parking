                    ...
                    <div x-data="{ dropdownOpen: false }" class="relative">
                        <button @click="dropdownOpen = !dropdownOpen"
                            ...
                            <img class="object-cover w-full h-full"
                                src="https://ui-avatars.com/api/?name=<?php echo urlencode($_SESSION['username'] ?? 'A') ?>&background=random"
                                alt="Avatar">
                        </button>
                        <div x-show="dropdownOpen" @click.away="dropdownOpen = false" x-cloak
                            class="absolute right-0 w-48 mt-2 py-2 bg-white rounded-md shadow-xl z-10">
                            <a href="<?php echo BASE_URL ?>/auth/logout" id="logout-link"
                                class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-500 hover:text-white">Logout</a>
                        </div>
                    </div>
                </div>
            </header>
